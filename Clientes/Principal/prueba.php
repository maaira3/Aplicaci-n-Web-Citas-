...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
           ...
           {
                var tab = $.ajax({
                    url:"../Ver_perfil/historial.php",
                    dataType:'text',
                    async:false,
                }).responseText;
                document.getElementById("tabla1").innerHTML = tab;
           }
        </script>
                        ...
                        <?php  
                         echo '
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="prueba.php">Ver perfil</a>
                ...
                echo'   <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                            ...
                            <div class="p-3 mb-2 bg-light text-dark" align="center">
                                ...
                                <div class="text-center">
                                  <img src="imagenes/avatar.png" width="98" height="100" class="rounded">
                                </div>
                                <br>
                                <div >
                                ...
                                <div >
                                    Proxima cita: <label > '.$_SESSION["horarioSesion"].'</label>
                                </div>
                                <div >
                                    Terapeuta: <label >  '.$_SESSION["nombreTerapeuta"].'</label>
                                </div>
                                <br>
                                <div >
