            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../Principal/verTerapeutas.php">Terapeutas</a></li>
                     <li class="nav-item"><a class="nav-link" href="../Principal/verCitas.php">Citas</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Informacion Terapeutas</a></li>
                    <li class="nav-item"><a class="nav-link" href="../Principal/verClientes.php">Clientes</a></li>
                    <li class="nav-item"><a class="nav-link" href="../Principal/Registro_Terapeutas.php">Alta Terapeutas</a></li>
                    <?php 
                    echo
...
<header class="masthead">
  ...
  <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
    <div class="col-lg-6">
        <h3 align="center" style="color:white"> Agregar un nuevo terapeuta </h3>
        <br>
